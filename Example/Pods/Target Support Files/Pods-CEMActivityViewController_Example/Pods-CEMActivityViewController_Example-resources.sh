...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "../../Pod/Resources/Resource.bundle/Refresh@2x.png"
  install_resource "../../Pod/Resources/Resource.bundle/safari@2x.png"
  install_resource "$CONFIGURATION_BUILD_DIR/TencentOpenApiSDK/TencentOpenAPI.bundle"
