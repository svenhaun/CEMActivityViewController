...
- (UIImage *)activityImage {
    return [UIImage cem_imageNamed:@"img_ss_message" inBundle:NSBundle.cem_libBundle];
}
...
- (UIImage *)activityImage {
    return [UIImage cem_imageNamed:@"img_ss_email" inBundle:NSBundle.cem_libBundle];
}
